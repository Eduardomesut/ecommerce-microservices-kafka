package com.hiberus.enviadorpromociones;
...
public final class TestUtils {
    ...
    public static String getPromocionAsString(String file) throws IOException {
        return gson.toJson(getRecord(Map.class, file));
    }


    public static Promocion getPromocion(String file) throws IOException {
        return getRecord(Promocion.class, file);
    }
